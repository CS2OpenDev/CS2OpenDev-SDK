...
///         this stays data. The payoff is testability: every invariant below can be checked
...
///     that binds against the array (the only supported way) is unaffected by any renumbering
///     between releases.
/// </param>
/// <param name="Aliases">
...
///     no per-class generated hook. Carried as data rather than emitted code because data is
///     more portable.
/// </param>
